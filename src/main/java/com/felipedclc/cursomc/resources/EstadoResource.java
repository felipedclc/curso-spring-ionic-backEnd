...
import com.felipedclc.cursomc.dto.CidadeDTO;
import com.felipedclc.cursomc.dto.EstadoDTO;
import com.felipedclc.cursomc.services.CidadeService;
import com.felipedclc.cursomc.services.EstadoService;
...
public class EstadoResource {
	...
	public ResponseEntity<List<CidadeDTO>> findCidades(@PathVariable Integer estadoId) { // BUSCA A CIDADE CONFORME O ID DO ESTADO
