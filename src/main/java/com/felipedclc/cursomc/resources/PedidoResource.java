...
public class PedidoResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody Pedido obj) { // @RequestBody CONVERTE O JSON PARA O OBJETO JAVA
	...
	public ResponseEntity<Page<Pedido>> findPage(
			...
			@RequestParam(value = "orderBy", defaultValue = "date") String orderBy, // ORDEM POR INSTANTE
			@RequestParam(value = "direction", defaultValue = "DESC") String direction) { // ULTIMOS PEDIDOS PRIMEIRO
