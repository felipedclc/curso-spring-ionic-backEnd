package com.felipedclc.cursomc.services.validation.utils;

public class BR { // CODIGO DE VALIDAÇÃO DE CPF OU CNPJ
     ...
     * @return
     */
    public static boolean isValidCPF(final String ssn) { // VALIDA O CPF
     ...
     * @return
     */
    public static boolean isValidCNPJ(final String tin) { // VALIDA O CNPJ
